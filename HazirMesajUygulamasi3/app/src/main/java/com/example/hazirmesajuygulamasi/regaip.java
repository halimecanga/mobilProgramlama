...
public class regaip extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        kopyala1 = (Button) findViewById(R.id.button52);
        kopyala2 = (Button) findViewById(R.id.button53);
        kopyala3 = (Button) findViewById(R.id.button54);
        kopyala4 = (Button) findViewById(R.id.button55);
        kopyala5 = (Button) findViewById(R.id.button56);
        kopyala6 = (Button) findViewById(R.id.button57);
