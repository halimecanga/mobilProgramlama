...
public class anneler extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        kopyala1 = (Button) findViewById(R.id.button12);
        kopyala2 = (Button) findViewById(R.id.button13);
        kopyala3 = (Button) findViewById(R.id.button14);
        kopyala4 = (Button) findViewById(R.id.button15);
        kopyala5 = (Button) findViewById(R.id.button16);
        kopyala6 = (Button) findViewById(R.id.button17);
