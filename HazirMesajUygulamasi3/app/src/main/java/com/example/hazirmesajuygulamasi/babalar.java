...
public class babalar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        kopyala1 = (Button) findViewById(R.id.button10);
        kopyala2 = (Button) findViewById(R.id.button11);
        kopyala3 = (Button) findViewById(R.id.button18);
        kopyala4 = (Button) findViewById(R.id.button19);
        kopyala5 = (Button) findViewById(R.id.button20);
        kopyala6 = (Button) findViewById(R.id.button21);
