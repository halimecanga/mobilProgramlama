...
public class ramazan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        kopyala1 = (Button) findViewById(R.id.button28);
        kopyala2 = (Button) findViewById(R.id.button29);
        kopyala3 = (Button) findViewById(R.id.button30);
        kopyala4 = (Button) findViewById(R.id.button31);
        kopyala5 = (Button) findViewById(R.id.button32);
        kopyala6 = (Button) findViewById(R.id.button33);
