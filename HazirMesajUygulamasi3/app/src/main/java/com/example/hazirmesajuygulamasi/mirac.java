...
public class mirac extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        kopyala1 = (Button) findViewById(R.id.button46);
        kopyala2 = (Button) findViewById(R.id.button47);
        kopyala3 = (Button) findViewById(R.id.button48);
        kopyala4 = (Button) findViewById(R.id.button49);
        kopyala5 = (Button) findViewById(R.id.button50);
        kopyala6 = (Button) findViewById(R.id.button51);
