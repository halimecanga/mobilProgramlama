...
public class anasayfa extends AppCompatActivity {
    ...
    // 🎉 Yeni eklenen günler
    public void ogretmenlergit(View view) {
        Intent o = new Intent(getApplicationContext(), ogretmenler.class);
        startActivity(o);
    }

    public void kadinlargit(View view) {
        Intent k = new Intent(getApplicationContext(), kadinlar.class);
        startActivity(k);
    }

    public void yeniyilgit(View view) {
        Intent y = new Intent(getApplicationContext(), yeniyil.class);
        startActivity(y);
    }

    public void mezuniyetgit(View view) {
        Intent m = new Intent(getApplicationContext(), mezuniyet.class);
        startActivity(m);
    }
}
